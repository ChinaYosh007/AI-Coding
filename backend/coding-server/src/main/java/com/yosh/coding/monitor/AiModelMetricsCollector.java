...
public class AiModelMetricsCollector {
     ...
     * 记录请求次数
     */
    public void recordRequest(String userId, String appId, String version, String modelName, String status) {
     ...
     * 记录错误
     */
    public void recordError(String userId, String appId,String version, String modelName, String errorMessage) {
        String key = String.format("%s_%s_%s_%s_%s", userId, appId, version, modelName, errorMessage);
     ...
     * 记录Token消耗
     */
    public void recordTokenUsage(String userId, String appId, String version, String modelName,
                                 String tokenType, long tokenCount) {
        String key = String.format("%s_%s_%s_%s_%s", userId, appId, version, modelName, tokenType);
     ...
     * 记录响应时间
     */
    public void recordResponseTime(String userId, String appId, String version, String modelName, Duration duration) {
        String key = String.format("%s_%s_%s_%s", userId, appId, version, modelName);
