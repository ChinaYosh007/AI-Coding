    ...
    public static AsyncNodeAction<MessagesState<String>> create() {
        return node_async(state -> {
            ...
            try {
                ...
                // 使用 AI 服务进行智能图片收集
//                imageListStr = imageCollectionService.searchImages(originalPrompt);
                ResourceCollectionResult resourceCollectionResult = imageCollectionService.collectResources(originalPrompt);
                imageListStr = resourceCollectionResult.getResources().toString();
            } catch (Exception e) {
